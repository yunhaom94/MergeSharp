...
class BFTC:
    ...
    def set(self, id, value):
        req = req_construct("bftc", id, "s", [str(value)])
        req = msg_construct(self.server, req)
    ...
    def inc(self, id, value, rid = ""):
        req = req_construct("bftc", id, "i", [str(value), rid]) 
        req = msg_construct(self.server, req)
    ...
    def dec(self, id, value, rid = ""):
        req = req_construct("bftc", id, "d", [str(value), rid]) 
        req = msg_construct(self.server, req)
    ...
    def rev(self, id, value):
        req = req_construct("bftc", id, "r", [str(value)]) 
        req = msg_construct(self.server, req)
